...
require_once MACHH_PLUGIN_DIR . 'includes/forms/providers/class-machh-elementor-provider.php';
...
class Machh_Plugin {
    ...
    private function init_form_tracking() {
        ...
        $this->form_manager->add_provider( new Machh_Elementor_Provider( $this->http ) );
